...
class TicketResourceIT {
    ...
    void putExistingTicket() throws Exception {
        ...
        updatedTicket.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).creationDate(UPDATED_CREATION_DATE).status(UPDATED_STATUS);
    ...
    void partialUpdateTicketWithPatch() throws Exception {
        ...
        partialUpdatedTicket.title(UPDATED_TITLE).status(UPDATED_STATUS);
