...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TICKETCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TICKETCATEGORY actions', async () => {
      const arg = { id: 10370 };
    ...
    it('dispatches UPDATE_TICKETCATEGORY actions', async () => {
      const arg = { id: 10370 };
    ...
    it('dispatches PARTIAL_UPDATE_TICKETCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TICKETCATEGORY actions', async () => {
      const arg = 42666;
